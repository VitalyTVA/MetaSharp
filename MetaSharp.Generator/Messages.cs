...
namespace MetaSharp {
    ...
    public static class Messages {
        ...
        public static readonly Message DependecyProperty_UnsupportedSyntax = new Message("0022", "Syntax is not supported. Specify property name via string value, nameof() of lambda expression.");
